target_iotable_producer_price <- tar_plan(
  tar_change(
    # https://www.e-stat.go.jp/stat-search/files?page=1&layout=datalist&toukei=00200603&tstat=000001218140&stat_infid=000040187024
    file_iotable_basic_producer_price,
    download_file(
      url = "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040187024&fileKind=0",
