...
target_iotable_producer_price_47_okinawa <- tar_plan(
  tar_change(
    file_iotable_47_okinawa_basic_producer_price,
    download_file(
  ...
  iotable_47_okinawa_458_producer_price_competitive_import_ja = read_file_iotable_producer_price_basic_47_okinawa(
    file = file_iotable_47_okinawa_basic_producer_price
  ),
)
