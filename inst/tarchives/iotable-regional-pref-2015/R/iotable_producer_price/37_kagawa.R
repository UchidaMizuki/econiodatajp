...
target_iotable_producer_price_37_kagawa <- tar_plan(
  tar_change(
    file_iotable_37_kagawa_medium_producer_price,
    download_file(
  ...
  iotable_37_kagawa_105_producer_price_competitive_import_ja = read_file_iotable_producer_price_medium_37_kagawa(
    file = file_iotable_37_kagawa_medium_producer_price
  ),
)
