...
target_iotable_producer_price_13_tokyo <- tar_plan(
  tar_change(
    file_iotable_13_tokyo_small_producer_price,
    download_file(
  ...
  iotable_13_tokyo_182_producer_price_competitive_import_ja = read_file_iotable_producer_price_small_13_tokyo(
    file = file_iotable_13_tokyo_small_producer_price
  ),
)
