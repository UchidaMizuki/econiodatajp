...
target_iotable_producer_price_07_fukushima <- tar_plan(
  tar_change(
    ...
    download_file(
      ...
      destfile = "_targets/user/iotable_07_fukushima_105_producer_price_competitive_import_ja.xlsx"
    ),
    change = "0.1.0",
    format = "file"
  ),
...
read_file_iotable_producer_price_105_07_fukushima <- function(file) {
