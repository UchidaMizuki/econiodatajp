...
target_iotable_producer_price_42_nagasaki <- tar_plan(
  tar_change(
    ...
    download_file(
      ...
      destfile = "_targets/user/iotable_42_nagasaki_107_producer_price_competitive_import_ja.xlsx"
    ),
    change = "0.1.0",
    format = "file"
  ),
...
read_file_iotable_producer_price_107_42_nagasaki <- function(file) {
