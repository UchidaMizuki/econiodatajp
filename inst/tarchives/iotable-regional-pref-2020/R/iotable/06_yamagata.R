...
target_iotable_producer_price_06_yamagata <- tar_plan(
  tar_change(
    file_iotable_06_yamagata_108_producer_price_competitive_import_ja,
    download_file(
      url = "https://www.pref.yamagata.jp/documents/1637/r2io108.xlsx",
      destfile = "_targets/user/iotable_06_yamagata_108_producer_price_competitive_import_ja.xlsx"
    ),
    change = "0.1.0",
    format = "file"
  ),
  iotable_06_yamagata_108_producer_price_competitive_import_ja = read_file_iotable_producer_price_108_06_yamagata(
    file = file_iotable_06_yamagata_108_producer_price_competitive_import_ja
  ),
)

read_file_iotable_producer_price_108_06_yamagata <- function(file) {
